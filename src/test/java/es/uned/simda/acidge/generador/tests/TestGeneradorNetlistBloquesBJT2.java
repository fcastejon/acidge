...
public class TestGeneradorNetlistBloquesBJT2 
{
	private final static Logger logger = Logger.getLogger(TestGeneradorNetlistBloquesBJT2.class.getName());
	final static String newLine = String.format("%n");
	final static String GRAMMARTEST1 = "testNetlistBloquesBJT2.ebnf";
