...
public class TestGeneradorNetlistBloquesMOSFET2 
{
	...
	final static String GRAMMARTEST1 = "testNetlistBloquesMOSFET2.ebnf";
	...
	public void test1() 
	{
		...
		String expected = 
			"R 2 3 1.0e0 nulo1" + newLine +
			"R 3 2 2.4e5 nulo2" + newLine +
			...
			"R 8 10 3.4e9 nulo1" + newLine +
			"R 9 10 3.8e9 nulo2" + newLine;
