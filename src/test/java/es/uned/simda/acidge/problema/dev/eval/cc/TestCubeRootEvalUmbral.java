...
*/
/*
 * TestCase para probar la clase CubeRootEval
 * 
 */
...
public class TestCubeRootEvalUmbral
{
	private final static Logger logger = Logger.getLogger(TestCubeRootEvalUmbral.class.getName());
	...
	private static double expected[] = { 0.0, 6.6145855e-2, 1.3096879e-1, 2.6458342, 1.25992105 };
	private static double expectedCan[] = { 0.0, 3.1498026e-3, 6.2366092e-3, 1.259921e-2, 5.999624e-3 };
	...
	public static void calculaVectores()
	{
		...
		for(int j = 0; j < puntos; j++)
		{
			...
			vo[0][j] = Math.signum(vi[j]) * Math.pow(Math.abs(vi[j]), (double) 1/3);
	...
	{	
		...
		DevEval eval = new CubeRootEvalUmbral(geproperties);
