...
public class TestSquareRootEval
{
	private final static Logger logger = Logger.getLogger(TestSquareRootEval.class.getName());
	...
	private static double expected[] = { 0.0, 0.04954181, 0.0980927, 1.9816722, 1.2395401 };
	private static double expectedCan[] = { 0.0, 0.00235913, 0.00467108, 0.00943653, 0.00590257 };
	...
	{			
		...
		DevEval eval = new SquareRootEval(geproperties);
