...
public class TestCubeRootEval
{
	private final static Logger logger = Logger.getLogger(TestCubeRootEval.class.getName());
	...
	private static double expected[] = { 0.0, 0.0510654, 0.1011094733, 2.0426156218, 0.9920676335 };
	private static double expectedCan[] = { 0.0, 0.00243169, 0.0048147368, 0.0097267411, 0.0047241316 };
	...
	{	
		...
		DevEval eval = new CubeRootEval(geproperties);
