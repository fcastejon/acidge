...
*/
/*
 * TestCase para probar la clase MatSensorEval
 * 
 */
...
public class TestMatSensorEval
{
	private final static Logger logger = Logger.getLogger(TestMatSensorEval.class.getName());
	...
	private static double expected[] = { 0.0, 0.1701, 5.25, 2.775 };
	...
	{	
		SensorEval eval = new MatSensorEval(null);
