...
public class TestSquareEvalUmbral
{
	private final static Logger logger = Logger.getLogger(TestSquareEvalUmbral.class.getName());
	...
	private static double expected[] = { 0.0, 6.5625e-3, 1.299375e-2, 2.625e-1, 1.25e-1 };
	private static double expectedCan[] = { 0.0, 3.125e-4, 6.1875e-4, 1.25e-3, 5.952381e-4 };
	...
	{	
		...
		DevEval eval = new SquareEvalUmbral(geproperties);
