...
public class TestMatGaussianEval
{
	private final static Logger logger = Logger.getLogger(TestMatGaussianEval.class.getName());
	...
	private static double expected[] = { 0.0, 0.063125, 11.343705, 0.54125 };
	...
	{	
		DevEval eval = new MatGaussianEval(null);
