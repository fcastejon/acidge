...
public class TestKozaVoltRefEval
{
	private final static Logger logger = Logger.getLogger(TestKozaVoltRefEval.class.getName());
	...
	private static double expected[] = { 0.0, 2.079, 1.0494, 16.7 };
	...
	{	
		VoltRefEval eval = new KozaVoltRefEval(null);
