...
public class TestCubeEvalUmbral
{
	private final static Logger logger = Logger.getLogger(TestCubeEvalUmbral.class.getName());
	...
	private static double expected[] = { 0.0, 0.001640625, 0.003248438, 0.065625, 0.03125 };
	...
	{	
		...
		DevEval eval = new CubeEvalUmbral(geproperties);
