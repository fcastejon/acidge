...
*/
/*
 * TestCase para probar la clase CubeEval
 * 
 */
...
public class TestCubeEval
{
	private final static Logger logger = Logger.getLogger(TestCubeEval.class.getName());
	...
	private static double expected[] = { 0.0, 0.00047273, 0.00093601, 0.018909375, 0.00945313 };
	private static double expectedCan[] = { 0.0, 2.25112e-5, 4.45721e-5, 9.00446e-5, 4.50149e-5 };
	...
	public void motor(int ind) //, int tipofunAdaptacion) 
	{	
		GEProperties geproperties = new GEProperties();
		geproperties.setUmbralError(-1);
		
		DevEval eval = new CubeEval(geproperties);
