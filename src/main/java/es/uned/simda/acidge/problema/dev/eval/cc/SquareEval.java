...
public class SquareEval extends ComputaEval 
{
	private final static Logger logger = Logger.getLogger(SquareEval.class.getName());
	...
	public SquareEval(GEProperties geproperties) 
	{
		super(geproperties);
		logger.info("SquareEval");
	}
