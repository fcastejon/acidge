...
public class CubeRootEval extends ComputaEval 
{
	private final static Logger logger = Logger.getLogger(CubeRootEval.class.getName());
	...
	public CubeRootEval(GEProperties geproperties) 
	{
		super(geproperties);
		logger.info("CubeRootEval:" + TERCIO);
	}
