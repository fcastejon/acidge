 ...
 * SquareEval
 * 
 * Evaluates a squaring function circuit
 * 
 */
...
public class SquareEvalUmbral extends ComputaEval 
{
	private final static Logger logger = Logger.getLogger(SquareEvalUmbral.class.getName());
	...
	public SquareEvalUmbral(GEProperties geproperties) 
	{
		super(geproperties);
		logger.info("SquareEvalUmbral" + error[iMax]);
	}
